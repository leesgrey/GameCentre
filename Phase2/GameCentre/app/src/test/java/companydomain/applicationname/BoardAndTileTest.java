...
public class BoardAndTileTest {
    ...
    public void testIsValidTap() {
        ...
        assertEquals(false, boardManager.isValidTap(2));
        assertEquals(false, boardManager.isValidTap(3));
        assertEquals(false, boardManager.isValidTap(4));
        assertEquals(false, boardManager.isValidTap(5));
        assertEquals(false, boardManager.isValidTap(6));
        assertEquals(false, boardManager.isValidTap(7));
        assertEquals(false, boardManager.isValidTap(8));
        assertEquals(false, boardManager.isValidTap(9));
        assertEquals(false, boardManager.isValidTap(12));
        assertEquals(false, boardManager.isValidTap(13));
